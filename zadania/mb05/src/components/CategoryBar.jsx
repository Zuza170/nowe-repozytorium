...
function CategoryBar({aktywna, onWybierz}) {
  return (
    <div id="kategorie" className="d-flex flex-wrap gap-2 mb-4">
      <button type="button" className={`btn btn-outline-primary${aktywna === 'wszytskie'
      ? ' active' : ''}`} aria-pressed={aktywna==='wszystkie'} onClick={() => onWybierz('wszystkie')}>
        Wszystkie
      </button>
